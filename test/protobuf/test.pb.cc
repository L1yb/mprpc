...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_2ftest_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ResponseMsg_protobuf_2ftest_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_2ftest_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_User_protobuf_2ftest_2eproto;
namespace fixbug {
...
static void InitDefaultsscc_info_GetFriendListRequest_protobuf_2ftest_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetFriendListRequest_protobuf_2ftest_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetFriendListRequest_protobuf_2ftest_2eproto}, {}};

static void InitDefaultsscc_info_GetFriendListResponse_protobuf_2ftest_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_GetFriendListResponse_protobuf_2ftest_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_GetFriendListResponse_protobuf_2ftest_2eproto}, {
      &scc_info_ResponseMsg_protobuf_2ftest_2eproto.base,
      &scc_info_User_protobuf_2ftest_2eproto.base,}};

static void InitDefaultsscc_info_LoginRequest_protobuf_2ftest_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_LoginRequest_protobuf_2ftest_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_LoginRequest_protobuf_2ftest_2eproto}, {}};

static void InitDefaultsscc_info_LoginResponse_protobuf_2ftest_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_LoginResponse_protobuf_2ftest_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_LoginResponse_protobuf_2ftest_2eproto}, {
      &scc_info_ResponseMsg_protobuf_2ftest_2eproto.base,}};

static void InitDefaultsscc_info_ResponseMsg_protobuf_2ftest_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ResponseMsg_protobuf_2ftest_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ResponseMsg_protobuf_2ftest_2eproto}, {}};

static void InitDefaultsscc_info_User_protobuf_2ftest_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_User_protobuf_2ftest_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_User_protobuf_2ftest_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_protobuf_2ftest_2eproto[6];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_protobuf_2ftest_2eproto[1];
static const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* file_level_service_descriptors_protobuf_2ftest_2eproto[1];

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_protobuf_2ftest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_protobuf_2ftest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\023protobuf/test.proto\022\006fixbug\"2\n\013Respons"
  "eMsg\022\022\n\nerror_code\030\001 \001(\005\022\017\n\007err_msg\030\002 \001("
  "\014\")\n\014LoginRequest\022\014\n\004name\030\001 \001(\014\022\013\n\003pwd\030\002"
  " \001(\014\"C\n\rLoginResponse\022!\n\004rmsg\030\001 \001(\0132\023.fi"
  "xbug.ResponseMsg\022\017\n\007success\030\002 \001(\010\"&\n\024Get"
  ...
  "\001 \001(\0132\023.fixbug.ResponseMsg\022!\n\013friend_lis"
  "t\030\002 \003(\0132\014.fixbug.User2\224\001\n\016UserServiceRpc"
  "\0224\n\005Login\022\024.fixbug.LoginRequest\032\025.fixbug"
  ".LoginResponse\022L\n\rGetFriendList\022\034.fixbug"
  ".GetFriendListRequest\032\035.fixbug.GetFriend"
  "ListResponseB\003\200\001\001b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_protobuf_2ftest_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_protobuf_2ftest_2eproto_sccs[6] = {
  &scc_info_GetFriendListRequest_protobuf_2ftest_2eproto.base,
  &scc_info_GetFriendListResponse_protobuf_2ftest_2eproto.base,
  &scc_info_LoginRequest_protobuf_2ftest_2eproto.base,
  &scc_info_LoginResponse_protobuf_2ftest_2eproto.base,
  &scc_info_ResponseMsg_protobuf_2ftest_2eproto.base,
  &scc_info_User_protobuf_2ftest_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_protobuf_2ftest_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_protobuf_2ftest_2eproto = {
  false, false, descriptor_table_protodef_protobuf_2ftest_2eproto, "protobuf/test.proto", 585,
  &descriptor_table_protobuf_2ftest_2eproto_once, descriptor_table_protobuf_2ftest_2eproto_sccs, descriptor_table_protobuf_2ftest_2eproto_deps, 6, 0,
  schemas, file_default_instances, TableStruct_protobuf_2ftest_2eproto::offsets,
  file_level_metadata_protobuf_2ftest_2eproto, 6, file_level_enum_descriptors_protobuf_2ftest_2eproto, file_level_service_descriptors_protobuf_2ftest_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_protobuf_2ftest_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_protobuf_2ftest_2eproto)), true);
namespace fixbug {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* User_Sex_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_protobuf_2ftest_2eproto);
  return file_level_enum_descriptors_protobuf_2ftest_2eproto[0];
}
...
void ResponseMsg::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ResponseMsg_protobuf_2ftest_2eproto.base);
  err_msg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  error_code_ = 0;
}
...
void LoginRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_LoginRequest_protobuf_2ftest_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  pwd_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
void LoginResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_LoginResponse_protobuf_2ftest_2eproto.base);
...
const GetFriendListRequest& GetFriendListRequest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendListRequest_protobuf_2ftest_2eproto.base);
  return *internal_default_instance();
}
...
void User::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_User_protobuf_2ftest_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
...
void GetFriendListResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFriendListResponse_protobuf_2ftest_2eproto.base);
  rmsg_ = nullptr;
}
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* UserServiceRpc::descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_protobuf_2ftest_2eproto);
  return file_level_service_descriptors_protobuf_2ftest_2eproto[0];
}
...
void UserServiceRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
                             ...
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), file_level_service_descriptors_protobuf_2ftest_2eproto[0]);
  switch(method->index()) {
    case 0:
      Login(controller,
